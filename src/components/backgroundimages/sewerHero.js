...
const BackgroundSection = ({ className }) => (
  <StaticQuery
    query={graphql`
      query {
        desktop: file(relativePath: { eq: "tracer-wire-manhole.JPG" }) {
          childImageSharp {
...
const StyledSewerBackground = styled(BackgroundSection)`
  width: 100%;
  margin-top: 122px;
  height: 400px;
...
export default StyledSewerBackground
